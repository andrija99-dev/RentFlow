...
internal sealed class UpdateWebhookSubscriptionUrlCommandHandler(
    IWebhookSubscriptionRepository subscriptions,
    IWebhookSubscriptionReadService readService,
    IUnitOfWork unitOfWork,
    ICurrentUser currentUser) : ICommandHandler<UpdateWebhookSubscriptionUrlCommand>
{
    ...
    public async Task Handle(UpdateWebhookSubscriptionUrlCommand request, CancellationToken cancellationToken)
    {
        ...
        subscription.UpdateTargetUrl(request.TargetUrl);
